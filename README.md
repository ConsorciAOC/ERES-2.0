...
Us suggerim que a l'hora de realitzar la vostra integració amb ERES tingueu presents les recomanacions recollides al document [La privacitat des del disseny i la privacitat per defecte - Guia per a desenvolupadors](https://apdcat.gencat.cat/ca/documentacio/guies_basiques/Guies-apdcat/la-privacitat-des-del-disseny-i-la-privacitat-per-defecte.-guia-per-a-desenvolupadors/) de l'APDCAT.
